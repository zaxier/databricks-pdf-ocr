...
class ClaudeClient:
    ...
    def _validate_endpoint(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to validate endpoint: {e}") from e

    def extract_text_from_image(
        self, image_data: bytes, image_format: str = "PNG", custom_prompt: str | None = None
    ) -> dict[str, Any]:
        """
        ...
        if not workspace_url:
            ...
            try:
                ...
                raise ValueError("Could not determine Databricks workspace URL") from e
        ...
        if not token:
            ...
            try:
                ...
                raise ValueError("Could not determine Databricks access token") from e
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                response = requests.post(
                    endpoint_url, headers=headers, json=payload, timeout=self.timeout
                )
    ...
    def extract_text_from_pdf_pages(
        self, page_images: list[bytes], image_format: str = "PNG"
    ) -> list[dict[str, Any]]:
        """
    ...
    def test_connection(self) -> dict[str, Any]:
        ...
        try:
            ...
            result = self.extract_text_from_image(
                test_image, "PNG", "This is a test. Please respond with 'TEST OK'."
            )
